...
class RGBColor:
    def __init__(self, text_color=(0, 0, 0), bg_color=(255, 255, 255),
                 outline_color=(0, 0, 0)):
    ...
    def randomize(self):
        self.text_color = (random.randint(0, 255), random.randint(0, 255),
                           random.randint(0, 255))
        self.bg_color = (random.randint(0, 255), random.randint(0, 255),
                         random.randint(0, 255))
        self.outline_color = (random.randint(0, 255), random.randint(0, 255),
                              random.randint(0, 255))
    ...
    def is_legible(self):
        ...
        print("contrast_ratio: %f", contrast_ratio)
